                ...
                rows.append(
                    {
                        ...
                        "CODICE_CONTRATTO": "SFA-01108117",
                        "CENTRO_COSTO": "CDC-00077336",
                        "CODICE_IDENTIFICATIVO_CLIENTE": "1407457445",
                        "PRODOTTO": "APT000901",
                        ...
                        "VIA_MITTENTE": "Via Gazzana priaroggia" or "",
                        "NUMERO_CIVICO_MITTENTE":  "83" or "snc",
                        ...
                        "CODICE_NAZIONE_MITTENTE": "IT1" or "",
                        "NAZIONE_MITTENTE": "ITALIA" or "",
                        "NOTE1_MITTENTE": "",
                        "COGNOME_RAGSOC_DESTINATARIO": partner_rit.display_name.replace('Indirizzo di consegna','') or "",
                        "CONTATTO_DESTINATARIO_REF": partner_rit.ref or "",
                        "EMAIL_DESTINATARIO": partner_rit.email or "",
                        "NUMERO_TELEFONO_DESTINATARIO": partner_rit.phone or "",
                        "NUMERO_CELLULARE_DESTINATARIO": partner_rit.phone or "",
                        "VIA_DESTINATARIO": partner_rit.street or "",
                        "NUMERO_CIVICO_DESTINATARIO": partner_rit.street2 or "snc",
                        "CAP_DESTINATARIO": partner_rit.zip or "",
                        "LOCALITA_DESTINATARIO": partner_rit.city or "",
                        "PROVINCIA_DESTINATARIO": state_code_rit or "IT",
                        "CODICE_NAZIONE_DESTINATARIO": "ITA1",
                        "NAZIONE_DESTINATARIO": partner_rit.country_id.name or "IT",
                        "NOTE1_DESTINATARIO": order.note or "",
                        "COGNOME_RAGSOC_RITIRO": "UDEM PHARMA SRL" ,
                        "CONTATTO_RITIRO_REF":  "",
                        "EMAIL_RITIRO": "logistica@udempharma.com",
                        "NUMERO_TELEFONO_RITIRO": order.company_id.phone or "",
                        "NUMERO_CELLULARE_RITIRO": order.company_id.mobile or "",
                        "VIA_RITIRO":  "Via Gazzana priaroggia" , #37
                        "NUMERO_CIVICO_RITIRO": "83" or "snc",
                        "CAP_RITIRO": order.company_id.zip or "",
                        "LOCALITA_RITIRO": order.company_id.city or "",
                        "PROVINCIA_RITIRO": order.company_id.state_id.code or "",
                        "CODICE_NAZIONE_RITIRO": order.company_id.country_id.code or "",
                        "NAZIONE_RITIRO": order.company_id.country_id.name or "",
                        "NOTE1_RITIRO":  "",
                        "ID_LDV": "",
                        "NUMERO_RIFERIMENTO_SPEDIZIONE": order.name or pick.origin or "",
                        "IDENTIFICATIVO_COLLO": pick.name or pick.origin or "",
                        "NUMERO_COLLI": 1,
                        "PESO_COLLO": 1000,
                        "LARGHEZZA": "",
                        "ALTEZZA": "",
