...
class ProductLabelLayout(models.TransientModel):
    ...
    print_format = fields.Selection( selection_add=[('1x1', '1 x 1')] , ondelete={'1x1': 'set default'})
    ...
    def _prepare_report_data(self):
        ...
        elif self.print_format == '1x1':
            xml_id = 'stock_force_validate_picking.report_product_template_label_1x1'
