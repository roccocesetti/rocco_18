...
class ReportProductTemplateLabel1x1(models.AbstractModel):
    _name = 'report.stock_force_validate_picking.report_label1x1'
    _description = 'Product Label Report 1x1'
